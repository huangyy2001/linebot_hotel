...
line_bot_api = LineBotApi('8V5pFv5//RZOEE74Nb5yT60x5RU+mbYDm1UTi+cnzW9xlfZOlQLedFNeVjwPG0tCdxbRoh2RNoKEytsvYuJfbdys7Js08fxjtYHGat5AzPNb+4+4q/IxMb1GvB059rx8UagYSx5pL+Co4ypYgXwtawdB04t89/1O/w1cDnyilFU=')
handler = WebhookHandler('abdd66836a0be3f79e5f7ca3230eade5')

app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgresql://admin:123456@127.0.0.1:5432/hotel'
db = SQLAlchemy(app)
