...
line_bot_api = LineBotApi('r1YY2/SPMNwyQB12xeR0Uz388xfgGNqVcZu8oPfqyoRTYKQfoPnw5mNbdfaCz0N4oX3sZnea/fHstgxuke52qtGvcnZLZprzc+ibDS10L2Hc6FA5CmMKWUXWFtmX8G+mUASJgiVFuiKwX+V4+O6sqwdB04t89/1O/w1cDnyilFU=')
handler = WebhookHandler('7c0b17918207c27e8a6f0d76936819b0')
# 定義 PostgreSQL 連線字串
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://admin:123456@127.0.0.1:5432/hotel'
db = SQLAlchemy(app)
# 定義 LIFF ID
liffid = '1657764558-vJOd6KMO'
